...
namespace Test.Controller
{
    ...
    public class CategoryControllerTest
    {
        ...
        {
            Category category = new Category { CategoryName = "API", CategoryDescription = "Microservice", CategoryCreatedBy = 810584 };
        ...
        {
            int categoryId = 1;
            Category category = new Category { CategoryId=1, CategoryName = "Testing", CategoryDescription = "Integration Testing", CategoryCreatedBy = 8105845 };
            HttpRequestMessage request = new HttpRequestMessage();
            MediaTypeFormatter formatter = new JsonMediaTypeFormatter();
        ...
        {
            int categoryId = 3;
            Category category = new Category {CategoryId=3, CategoryName = "API", CategoryDescription = "Microservice", CategoryCreatedBy = 8105845 };
            HttpRequestMessage request = new HttpRequestMessage();
            MediaTypeFormatter formatter = new JsonMediaTypeFormatter();
