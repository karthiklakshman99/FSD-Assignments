...
namespace Test.Controller
{
    ...
    public class ReminderControllerTest
    {
        ...
        {
            int reminderId = 1;
            Reminder reminder= new Reminder {ReminderId=1, ReminderName = "Email", ReminderDescription = "Mail sender", ReminderType = "notification", ReminderCreatedBy = 8105845 };
            HttpRequestMessage request = new HttpRequestMessage();
            MediaTypeFormatter formatter = new JsonMediaTypeFormatter();
        ...
        {
            int reminderId = 3;
            Reminder reminder = new Reminder { ReminderId = 3, ReminderName = "SMS", ReminderDescription = "SMS sender", ReminderType = "notification", ReminderCreatedBy = 8105845 };
            HttpRequestMessage request = new HttpRequestMessage();
            MediaTypeFormatter formatter = new JsonMediaTypeFormatter();
