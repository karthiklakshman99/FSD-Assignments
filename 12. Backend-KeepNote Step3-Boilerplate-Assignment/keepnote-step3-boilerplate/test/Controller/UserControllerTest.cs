...
namespace Test.Controller
{
    ...
    public class UserControllerTest
    {
        ...
        {
            User user = new User { UserId = 8105845, Password = "test123"};
            HttpRequestMessage request = new HttpRequestMessage();
            MediaTypeFormatter formatter = new JsonMediaTypeFormatter();
        ...
        {
            int userId = 8105845;
            User user = new User { UserId = 8105845, Password = "admin123", Contact="1234567890", UserName="John Simon" };
            HttpRequestMessage request = new HttpRequestMessage();
            MediaTypeFormatter formatter = new JsonMediaTypeFormatter();
        ...
        {
            User user = new User { UserId = 8105845, UserName = "John Simon", Password = "test123", Contact = "9876543210" };
            HttpRequestMessage request = new HttpRequestMessage();
            MediaTypeFormatter formatter = new JsonMediaTypeFormatter();
        ...
        {
            User user = new User { UserId = 8105847, UserName = "Sam", Password = "test123", Contact = "9876543210" };
            HttpRequestMessage request = new HttpRequestMessage();
            MediaTypeFormatter formatter = new JsonMediaTypeFormatter();
        ...
        {
            int userId = 8105847;
            User user = new User { UserId = 8105847, Password = "admin123", Contact = "1234567890", UserName = "Sam Kaul" };
            HttpRequestMessage request = new HttpRequestMessage();
            MediaTypeFormatter formatter = new JsonMediaTypeFormatter();
