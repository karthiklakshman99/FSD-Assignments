...
namespace Test.Service
{
    ...
    public class CategoryServiceTest
    {
        ...
        public void CreateCategoryShouldReturnCategory()
        {
            ...
            Category category = new Category { CategoryName = "API", CategoryDescription = "Microservice", CategoryCreatedBy = 8105845, CategoryCreationDate=new System.DateTime() };
        ...
        public void GetCategoryByIdShouldReturnCategory()
        {
            var mockRepo = new Mock<ICategoryRepository>();
            var Id = 1;
            Category category = new Category { CategoryName = "Testing", CategoryDescription = "Unit Testing", CategoryCreatedBy = 8105845, CategoryCreationDate = new DateTime() };
        ...
        [Fact, TestPriority(4)]
        public void DeleteCategoryShouldReturnTrueButThrowsException()
        {
            var mockRepo = new Mock<ICategoryRepository>();
            var Id = 2;
            ...
            Assert.Equal($"Category with id: {Id} does not exist", actual.Message);
        }
        ...
        {
            int Id = 1;
            Category category = new Category { CategoryName = "Testing", CategoryDescription = "Integration Testing", CategoryCreatedBy = 8105845 };
        ...
        private List<Category> GetCategories()
        {
            List<Category> categories = new List<Category> {
               new Category {CategoryName= "Testing", CategoryDescription="Unit Testing",CategoryCreatedBy=8105845 }
            };
        ...
        {
            int categoryId = 105;
            Category category = new Category { CategoryName = "Testing", CategoryDescription = "Unit Testing", CategoryCreatedBy = 8105845 };
