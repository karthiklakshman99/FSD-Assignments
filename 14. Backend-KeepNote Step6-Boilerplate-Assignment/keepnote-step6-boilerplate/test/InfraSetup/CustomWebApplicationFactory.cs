            ...
            _ = builder.ConfigureServices(static services =>
            {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    try
                    {
                        ...
                        {
                            new() {Id=101, Category= new NoteService.Models.Category{Id=101, Name="Sports", CreatedBy="Mukesh", Description="All about sports", CreationDate=DateTime.Now },
                            ...
                            new() {Id=101, Category= new NoteService.Models.Category{Id=102, Name="Sports", CreatedBy="Sachin", Description="All about sports", CreationDate=DateTime.Now },
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    {
                        // Seed the database with some specific test data.
                        authDb.Users.Add(new AuthenticationService.Models.User("Mukesh", "admin123") { UserId = "Mukesh", Password = "admin123" });
                        authDb.SaveChanges();
                    }
                    catch (Exception ex)
                    {
