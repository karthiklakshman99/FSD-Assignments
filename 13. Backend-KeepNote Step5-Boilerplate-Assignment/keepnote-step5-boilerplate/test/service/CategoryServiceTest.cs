...
namespace ServiceTest
{
    ...
    public class CategoryServiceTest
    {
        ...
        public void CreateCategoryShouldReturnCategory()
        {
            ...
            var service = new CategoryService.Service.CategoryServices(mockRepo.Object);
        ...
        private List<Category> GetCategories()
        {
            var categories = new List<Category> {
                ...
                {Id=101, Name="Sports", CreatedBy="Mukesh", Description="All about sports", CreationDate=new DateTime() },
                new Category
                {Id=102, Name="Politics", CreatedBy="Mukesh", Description="INDIAN politics", CreationDate=new DateTime() }
            };
